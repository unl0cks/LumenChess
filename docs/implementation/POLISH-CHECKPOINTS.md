...
- Checkpoint `1f306f9e8804daa7715945b6d96c2a02c3d339c0` compiled and passed the proportional checkpoint and APK-size gate, but API 37 instrumentation proved the internal piece tags intentionally live in the unmerged semantics tree. Commits `4f9b9b2ae557ca11be58a370e041c93cb20935ee` and `c316c823dbb533e47cccd8046aad0fb7f662250c` corrected only those test finders to query `useUnmergedTree = true`, as directed by the Compose failure diagnostics.
