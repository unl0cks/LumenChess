...
class UciProtocolParserTest {
    ...
    fun commandEncoderProducesCanonicalUciCommands() {
        ...
        assertEquals("setoption name MultiPV value 3", UciCommandEncoder.encode(UciCommand.SetOption("MultiPV", "3")))
        ...
        assertEquals("go depth 12 nodes 50000 movetime 250", UciCommandEncoder.encode(UciCommand.Go(depth = 12, nodes = 50_000, moveTimeMillis = 250)))
