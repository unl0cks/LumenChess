...
class SettingsUiTest {
    ...
    fun appearancePresetAndIndividualOverridesRemainComposable() {
        ...
        composeRule.onNodeWithTag("customization-preset-midnight").performClick()
        composeRule.waitUntil(timeoutMillis = 5_000) {
        ...
        composeRule.onNodeWithTag("customization-background-graphite-haze").performClick()
        composeRule.waitUntil(timeoutMillis = 5_000) {
        ...
        composeRule.onNodeWithTag("customization-board-graphite").performClick()
        composeRule.onNodeWithTag("board-preview").assertIsDisplayed()
    }
}
